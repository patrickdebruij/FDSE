...
Lx = 3  # size in the x-direction
Lz = 10 # size in the vertical (z) direction 
...
duration = 20*3 # The non-dimensional duration of the simulation
...
# forcing
S_source = 33.95
source_index = (Int(Nx/2), 1, Nz)

S_forcing_func(x, y, z, t) = (x == source_index[1] && z == source_index[3]) ? S_source : 0.0

S_forcing = Forcing(S_forcing_func)
...
model = NonhydrostaticModel(; grid,
            ...
            forcing = (; S=S_forcing), # add the source term to the model
